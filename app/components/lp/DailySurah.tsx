...
export default function DailySurah () {
  ...
  return (
    <section className='flex items-center justify-center md:pb-28'>
      <div className='bg-secondary 2xl:w-[91.5rem] w-full py-6 md:py-16 px-6 md:px-36 2xl:rounded-[50px] justify-center grid text-white text-center gap-4 md:gap-11'>
        ...
        <p className='bg-[#16423C] font-light text-[9px] md:text-sm -mt-4 rounded-md p-1'>&quot;{isi}&quot;</p>
